...
const Footer = () => {
  ...
  return (
    <footer className="bg-quantoblue-dark text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Revolutionizing financial management with AI-powered accounting solutions for businesses of all sizes.
            </p>
          ...
          <div>
            ...
            <form className="space-y-2">
              <div className="flex">
                ...
                <button
                  type="submit"
                  className="bg-quantopurple hover:bg-quantopurple-dark px-4 py-2 rounded-r-md transition-colors"
                >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            &copy; {currentYear} QuantoBooks. All rights reserved.
          </p>
